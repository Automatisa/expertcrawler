...
public class StopWordRemover implements Remover {
	protected static HashSet<String> stopWords = new HashSet<>();

	@Override
	public boolean isRemovable(CharSequence word) {
		return staticIsRemovable(word.toString());
	}

	@Override
	public boolean containsRemovables(CharSequence text) {
		return staticContainsRemovables(text.toString());
	}

	@Override
	public String remove(CharSequence text) {
		return staticRemove(text.toString());
	}

	public static boolean staticIsRemovable(CharSequence word) {
		return stopWords.contains(word.toString().toLowerCase());
	}

	public static boolean staticContainsRemovables(CharSequence text) {
		String[] words = text.toString().split("[_\\W+]");
		for (int i = 0; i < words.length; i++)
			if (staticIsRemovable(words[i]))
				return true;

		return false;
	}

	public static String staticRemove(CharSequence text) {
		String[] words = text.toString().split("[_\\W+]");
	...
	static {
		//http://www.koders.com/java/fid04763A14AB2F6DCEE22818DDCE301ABBF804C571.aspx
		//The default stopwords are based on http://www.cs.cmu.edu/~mccallum/bow/rainbow/
		stopWords.add("a");
		stopWords.add("able");
		stopWords.add("about");
		stopWords.add("above");
